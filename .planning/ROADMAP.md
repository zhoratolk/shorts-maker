...
| 7. Profanity Auto-Bleep | 3/5 | In Progress|  |
...
- [x] 07-03-PLAN.md — ProfanityConfig dataclass (fail-open, default-off) + _validate + config.example.yaml section [AUDIO-01, AUDIO-02, AUDIO-03] (wave 1)
