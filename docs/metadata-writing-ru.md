...
- **Один релевантный эмодзи в конце тайтла** — выделяет название в ленте
  визуально. Ровно один, и только если он реально соответствует клипу;
  не добавлять к тайтлу с «⚠️ 18+»-префиксом, там акцент уже занят.
