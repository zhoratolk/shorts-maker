...
# --- Phase 10: outro card + social popups (overlay finalize pass) ----------
#
# Both features run as a SECOND ffmpeg pass over the already-rendered clip
# (see render_clip). This keeps the three primary command builders - and their
# fiddly filter_complex graphs (jumpcut folds, profanity amix, compilation) -
# completely untouched: when Phase 10 is disabled the base clip IS the final
# clip, byte-identical to today. The pass is fail-open (any error keeps the
# base clip), matching the diarization/audio_energy/hook_banner footing.
